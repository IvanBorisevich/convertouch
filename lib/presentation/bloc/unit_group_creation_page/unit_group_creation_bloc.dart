...
//
// class UnitGroupCreationBloc extends Bloc<ConvertouchCommonEvent, UnitGroupCreationState> {
...
//
//   @override
//   Stream<UnitGroupCreationState> mapEventToState(ConvertouchCommonEvent event) async* {
