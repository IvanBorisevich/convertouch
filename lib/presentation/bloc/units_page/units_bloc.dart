...
class UnitsBloc extends Bloc<ConvertouchPageEvent, UnitsState> {
  ...
  @override
  Stream<UnitsState> mapEventToState(ConvertouchPageEvent event) async* {
    if (event is FetchUnitsForGroup) {
