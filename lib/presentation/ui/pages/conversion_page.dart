    ...
    return appBlocBuilder(
      builderFunc: (appState) {
        ...
        return ConvertouchPage(
          ...
          floatingActionButton: BlocBuilder<ConversionBloc, ConversionState>(
            builder: (_, conversionState) {
              if (conversionState is! ConversionBuilt) {
                return const SizedBox.shrink();
              }
              ...
              return Wrap(
                ...
                children: [
                  ConvertouchRefreshFloatingButton(
                    visible: conversionState.conversion.unitGroup.refreshable,
                    disabled: !conversionState.conversion.readyToRefresh,
                    theme: appState.theme,
                  ),
