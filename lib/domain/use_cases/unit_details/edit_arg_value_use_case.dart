...
class EditArgValueUseCase extends ModifyUnitDetailsUseCase<String> {
  const EditArgValueUseCase();

  @override
  ValueModel getDraftArgValue(InputUnitDetailsModifyModel<String> input) {
    return ValueModel.ofString(input.delta);
  }

  @override
  String getErrorMessage() {
    return "Error when editing arg unit value in unit details";
  }
}
