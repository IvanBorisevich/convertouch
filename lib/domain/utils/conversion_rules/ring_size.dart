...
const MappingTable<NumRangeCriterion, CountryCode> _ringSizes = MappingTable(
  ...
  rows: [
    ...
    MappingRow(
      criterion: NumRangeCriterion(15.3, 15.6),
      row: {
        CountryCode.us: 4.5,
        CountryCode.uk: "I",
        CountryCode.de: 48,
    ...
    MappingRow(
      criterion: NumRangeCriterion(15.6, 16.2),
      row: {
        CountryCode.us: 5,
        CountryCode.uk: "J",
        CountryCode.de: 49,
    ...
    MappingRow(
      criterion: NumRangeCriterion(16.2, 16.6),
      row: {
        CountryCode.us: 5.5,
        CountryCode.uk: "K",
        CountryCode.de: 51,
    ...
    MappingRow(
      criterion: NumRangeCriterion(16.6, 16.9),
      row: {
        CountryCode.us: 6,
        CountryCode.uk: "L",
        CountryCode.de: 52,
    ...
    MappingRow(
      criterion: NumRangeCriterion(16.9, 17.2),
      row: {
        CountryCode.us: 6.5,
        CountryCode.uk: "M",
        CountryCode.de: 53,
    ...
    MappingRow(
      criterion: NumRangeCriterion(17.2, 17.8),
      row: {
        CountryCode.us: 7,
        CountryCode.uk: "N",
        CountryCode.de: 54,
    ...
    MappingRow(
      criterion: NumRangeCriterion(17.8, 18.1),
      row: {
        CountryCode.us: 7.5,
        CountryCode.uk: "O",
        CountryCode.de: 56,
    ...
    MappingRow(
      criterion: NumRangeCriterion(18.1, 18.5),
      row: {
        CountryCode.us: 8,
        CountryCode.uk: "P",
        CountryCode.de: 57,
    ...
    MappingRow(
      criterion: NumRangeCriterion(18.5, 19.1),
      row: {
        CountryCode.us: 8.5,
        CountryCode.uk: "Q",
        CountryCode.de: 58,
    ...
    MappingRow(
      criterion: NumRangeCriterion(19.1, 19.4),
      row: {
        CountryCode.us: 9,
        CountryCode.uk: "R",
        CountryCode.de: 60,
    ...
    MappingRow(
      criterion: NumRangeCriterion(19.4, 19.7),
      row: {
        CountryCode.us: 9.5,
        CountryCode.uk: "S",
        CountryCode.de: 61,
    ...
    MappingRow(
      criterion: NumRangeCriterion(19.7, 20.4),
      row: {
        CountryCode.us: 10,
        CountryCode.uk: "T",
        CountryCode.de: 62,
    ...
    MappingRow(
      criterion: NumRangeCriterion(20.4, 20.7),
      row: {
        CountryCode.us: 10.5,
        CountryCode.uk: "U",
        CountryCode.de: 64,
    ...
    MappingRow(
      criterion: NumRangeCriterion(20.7, 21),
      row: {
        CountryCode.us: 11,
        CountryCode.uk: "V",
        CountryCode.de: 65,
    ...
    MappingRow(
      criterion: NumRangeCriterion(21, 21.6),
      row: {
        CountryCode.us: 11.5,
        CountryCode.uk: "W",
        CountryCode.de: 66,
    ...
    MappingRow(
      criterion: NumRangeCriterion(21.6, 22),
      row: {
        CountryCode.us: 12,
        CountryCode.uk: "X",
        CountryCode.de: 68,
    ...
    MappingRow(
      criterion: NumRangeCriterion(22, 22.3),
      row: {
        CountryCode.us: 12.5,
        CountryCode.uk: "Y",
        CountryCode.de: 69,
    ...
    MappingRow(
      criterion: NumRangeCriterion(22.3, 22.9),
      row: {
        CountryCode.us: 13,
        CountryCode.uk: "Z",
        CountryCode.de: 70,
    ...
    MappingRow(
      criterion: NumRangeCriterion(22.9, 23.2),
      row: {
        CountryCode.us: 13.5,
        CountryCode.uk: "Z+2",
        CountryCode.de: 72,
    ...
    MappingRow(
      criterion: NumRangeCriterion(23.2, 23.6),
      row: {
        CountryCode.us: 14,
        CountryCode.uk: "Z+3",
        CountryCode.de: 73,
    ...
    MappingRow(
      criterion: NumRangeCriterion(23.6, 23.9),
      row: {
        CountryCode.us: 14.5,
        CountryCode.uk: "Z+4",
        CountryCode.de: 74,
    ...
    MappingRow(
      criterion: NumRangeCriterion(23.9, double.infinity),
      row: {
        CountryCode.us: 15,
        CountryCode.uk: "Z+5",
        CountryCode.de: null,
